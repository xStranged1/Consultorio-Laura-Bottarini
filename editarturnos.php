...
$sql = "SELECT * from turno WHERE id_turno=".$_GET['edit'];
...
<body style="background-color: rgba(249,238,245,1);">
	...
	<form style="background-color: rgba(249,238,245,1); border:1px; border-color: #000;" class="well form-horizontal" action="edicionturno.php" method="post" id="contact_form"> 
...
<!-- Form Name -->
<legend><center><h2><b>Editar turno de <?php 
...
<div class="form-group form-check">
	<input type="hidden" value="<?php echo $row['id_turno']; ?>	 " name="id_turno">
				  ...
				  <input type="radio" <?php if ($row['tipo']==1) {
				  	echo "checked";
				  ...
				  <input type="radio" class="form-check-input" id="materialGroupExample1" name="tipo" <?php if ($row['tipo']==2) {
				  	echo "checked";
				  } ?> value="2">
...
<div class="form-group">
  ...
  <div style="float: left;" class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy/mm/dd">
                    ...
                    <input name="fecha" class="form-control" size="16" type="text" value="<?php echo $row['fecha'];?>"readonly>
...
<div class="form-group">
  ...
  <div style="float: left;" class="input-group date form_ime col-md-12" data-date="" data-date-format="hh:ii" data-link-format="hh:ii">
                    <input placeholder="Hora" required name="hora" class="form-control" size="16" type="text" value="<?php echo $row['hora'];?>">
